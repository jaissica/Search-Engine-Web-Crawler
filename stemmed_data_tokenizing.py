...
#step 3(stemmed): tokenizing
f = open("data_stemmed.json","r")
file = json.load(f)
...
save_file = open("stemmed_tokens.json", "w")
json.dump({"tokens" : tokens}, save_file, indent = 6)
save_file.close()


save_file = open("stemmed_words_id_dict.json", "w")
json.dump(words_id_dict, save_file, indent = 6)
save_file.close()


save_file = open("stemmed_doc_len_stat.json", "w")
